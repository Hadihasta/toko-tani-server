          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              <Image
                ...
                height={40}
              />
              <h1 className="text-xl font-semibold text-gray-900">Dashboard Petani</h1>
            </div>
            <div className="flex items-center space-x-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            <div className="flex items-center">
              <div className="p-2 bg-yellow-100 rounded-lg">
                <IconShoppingCart className="h-6 w-6 text-yellow-600" />
              </div>
              <div className="ml-4">
          ...
          >
            <div className="flex items-center">
              <div className="p-2 bg-purple-100 rounded-lg">
                <IconTruck className="h-6 w-6 text-purple-600" />
              </div>
              <div className="ml-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <motion.div
            ...
            className="bg-white rounded-lg shadow p-6"
          >
            <h3 className="text-lg font-medium text-gray-900 mb-4">Kelola Produk</h3>
            <div className="space-y-3">
              <Link
                href="/user/products"
                className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
              >
                <span className="text-sm font-medium text-gray-700">Lihat Semua Produk</span>
              ...
              >
                <span className="text-sm font-medium text-green-700">Tambah Produk Baru</span>
          ...
          <motion.div
            ...
            className="bg-white rounded-lg shadow p-6"
          >
            <h3 className="text-lg font-medium text-gray-900 mb-4">Pesanan</h3>
            <div className="space-y-3">
              <Link
                href="/user/orders"
                className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors"
              >
                <span className="text-sm font-medium text-gray-700">Lihat Semua Pesanan</span>
                <IconShoppingCart size={16} className="text-gray-400" />
              </Link>
              <Link
                href="/user/orders/pending"
          ...
          <motion.div
            ...
            className="bg-white rounded-lg shadow p-6"
          >
            <h3 className="text-lg font-medium text-gray-900 mb-4">Toko</h3>
            <div className="space-y-3">
              <Link
                href="/menu"
                className="flex items-center justify-between p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors"
              >
                <span className="text-sm font-medium text-blue-700">Lihat Toko</span>
